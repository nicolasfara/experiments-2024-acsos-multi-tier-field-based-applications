...
import it.unibo.alchemist.model.{Action, AllocatorProperty, Environment, LocalNode, Node, Position, Reaction}
...
class ModularizationRuntime[T, P <: Position[P]](
  ...
  override def execute(): Unit = {
    ...
    if (node.getId == 8) allocator.setComponentAllocation("it.unibo.modularization.EmergencyService", LocalNode)
